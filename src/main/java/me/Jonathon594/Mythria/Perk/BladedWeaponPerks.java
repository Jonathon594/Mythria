    ...
    public List<Perk> getPerks(PerkType type) {
        return ImmutableList.of(
                new RootPerk("bladed_weaponry", type, MythriaItems.BONE_DAGGER, null, 0,
                        ...
                        .addDescriptionLine("A strong offense is the best defence.")
                        .addRequiredAttribute(Attribute.DEXTERITY, 3)
                        .addRequiredAttribute(Attribute.STRENGTH, 2),

                new Perk("basic_swordsmanship", type, MythriaItems.TIN_SWORD, MythicSkills.SWORDS, 0, () -> BLADED_WEAPONRY)
                        .setDisplayName("Basic Swordsmanship")
                        .addDescriptionLine("Swordsmanship is all about finesse.")
                        .addAttributeFlag(AttributeFlag.SWORD_ABILITY_SWEEP)
                        .addRequiredAttribute(Attribute.DEXTERITY, 5),

                new Perk("basic_axes", type, MythriaItems.TIN_AXE, MythicSkills.AXES, 0, () -> BLADED_WEAPONRY)
                        .setDisplayName("Basic Axes")
                        .addDescriptionLine("Axes are heavier weapons designed to overpower an enemy.")
                        .addAttributeFlag(AttributeFlag.AXE_ABILITY_CRIT)
                        .addRequiredAttribute(Attribute.STRENGTH, 5),

                new Perk("basic_daggers", type, MythriaItems.TIN_DAGGER, MythicSkills.DAGGERS, 0, () -> BLADED_WEAPONRY)
                        .setDisplayName("Basic Daggers")
                        .addDescriptionLine("Daggers are smaller and faster blades for quick strikes.")
