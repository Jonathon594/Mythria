...
public class StoneFurnaceBlock extends AbstractMythriaFurnaceBlock {
    public StoneFurnaceBlock(Material material, String name, double weight, SoundType sound) {
