...
public class TreeMenuNode {
    ...
    private final TreeMenuNode parent;
    private final TreeMenuNode sibling;
    private final int index;
    private final List<TreeMenuNode> children = Lists.newArrayList();
    private TreeMenuNode ancestor;
    private TreeMenuNode thread;
    private int x;
    private float y;
    private float mod;
    ...
    public TreeMenuNode(TreeMenuOption advancementIn, @Nullable TreeMenuNode parentIn, @Nullable TreeMenuNode siblingIn, int indexIn, int xIn) {
    ...
    public static void layout(TreeMenuOption root) {
        if (root.getDisplay() == null) {
            throw new IllegalArgumentException("Can't position children of an invisible root!");
        } else {
            TreeMenuNode advancementtreenode = new TreeMenuNode(root, null, null, 1, 0);
    ...
    private TreeMenuNode apportion(TreeMenuNode nodeIn) {
        if (this.sibling != null) {
            ...
            TreeMenuNode advancementtreenode3 = this.parent.children.get(0);
            float f = this.mod;
            float f1 = this.mod;
