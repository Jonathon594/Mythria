...
public enum TreeTabType {
    ...
    TreeTabType(int p_i47386_3_, int p_i47386_4_, int widthIn, int heightIn, int p_i47386_7_) {
    ...
    public void draw(MatrixStack matrixStack, AbstractGui guiIn, int x, int y, boolean p_192651_4_, int p_192651_5_) {
        int i = this.textureX;
        if (p_192651_5_ > 0) {
            i += this.width;
        }
        ...
        guiIn.blit(matrixStack, x + this.getX(p_192651_5_), y + this.getY(p_192651_5_), i, j, this.width, this.height);
    }
