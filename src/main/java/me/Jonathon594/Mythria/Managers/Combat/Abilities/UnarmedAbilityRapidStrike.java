...
public class UnarmedAbilityRapidStrike implements ICombatAbility {
    ...
    public void onCombatPost(PlayerEntity player, Profile profile, Entity target, CombatEvent.Post postEvent) {
        if (target instanceof LivingEntity) {
            ...
            TaskManager.addScheduleTask(new AttackTask(3, player, LivingEntity, other, EnumAttackType.BASIC, null));
            TaskManager.addScheduleTask(new AttackTask(6, player, LivingEntity, postEvent.getHand(), EnumAttackType.BASIC, null));
